...
echo $i" |"$cy"            Always Alone Blackhat"$i"            |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MR.HANZO17++             "$i"          |"
echo $i" |"$pu" IG :"$ku" https://instagram.com/alwaysaloneblackhat"$i" |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh] [Rizki d]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 081290006971"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" Ga ada"$i"                      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 081290006971"
echo $ku"Facebook :"$i" HanzoGanzz"
sleep 2
